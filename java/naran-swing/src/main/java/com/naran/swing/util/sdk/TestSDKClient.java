...
public class TestSDKClient {
	...
	private final static Logger LOGGER = LoggerFactory.getLogger(TestSDKClient.class);
	
//	public static String softwareSerialNo = "6SDK-EMY-6688-KEZRQ";// 软件序列号,请通过亿美销售人员获取
//	public static String key = "942545";// 序列号首次激活时自己设定
//	public static String password = "942545";// 密码,请通过亿美销售人员获取

	public static String softwareSerialNo = "6SDK-EMY-6688-JDVRK";// 软件序列号,请通过亿美销售人员获取
	public static String key = "399169";// 序列号首次激活时自己设定
	public static String password = "399169";// 密码,请通过亿美销售人员获取
	...
	public static void testSendSMS() {
		try {
			int i = SingletonClient.getClient().sendSMS(new String[] { "15157119489" }, "定", "",5);// 带扩展码
			System.out.println("testSendSMS=====" + i);
			LOGGER.info("sms STATUS = DFSLFSDKL");
			LOGGER.info("sms STATUS = DFSLFSDKL");
			LOGGER.info("sms STATUS = DFSLFSDKL");
			LOGGER.info("sms STATUS = DFSLFSDKL");
			LOGGER.info("sms STATUS = " + i);
//			sms.setStatus(String.valueOf(i));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
